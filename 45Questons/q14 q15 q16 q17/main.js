var guestList = ["Shayan", "Arqam", "Ali Murad"];
guestList.forEach(function (guest) { console.log("".concat(guest, " You are invited at the dinner")); });
...
// let dropped=;
console.log("".concat(guestList.pop(), ", I am  sorry I can't invite you to dinner."));
console.log("".concat(guestList.pop(), ", I am  sorry I can't invite you to dinner."));
console.log("".concat(guestList.pop(), ", I am  sorry I can't invite you to dinner."));
console.log("".concat(guestList.pop(), ", I am  sorry I can't invite you to dinner."));
guestList.forEach(function (guest) { console.log("".concat(guest, " You are still invited")); });
